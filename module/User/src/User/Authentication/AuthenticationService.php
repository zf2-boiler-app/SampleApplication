...
class AuthenticationService extends \Zend\Authentication\AuthenticationService{
    ...
    /**
     * @param \User\Service\UserService $oUserService
     * @return \User\Authentication\AuthenticationService
     */
    public function setUserService(\User\Service\UserService $oUserService){
    ...
    public function login($sIdentity,$sCredential, $sService = self::AUTH_SERVICE_LOCAL){
        ...
        elseif($this->userService){
        	...
        	if(($oUser = $this->userService->getUserFromProvider($oUserProfile,$sService)) instanceof \User\Entity\UserEntity){
